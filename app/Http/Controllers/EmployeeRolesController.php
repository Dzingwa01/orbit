    ...
    public function getRoles()
    {
        ...
        return DataTables::of($roles)
            ->addColumn('action', function ($role) {
                return '<a href="employee_view_role/' . $role->id . '" title="View Role" class=""><i class="glyphicon glyphicon-eye-open"></i></a><a href="employee_edit_role/' . $role->id . '" style="margin-left:1em" title="Edit User" class=""><i class="glyphicon glyphicon-edit"></i></a><a href="employee_delete_role/' . $role->id . '" style="margin-left:1em" class="" title="Delete User"><i class="glyphicon glyphicon-trash "></i></a>';
            })
            ->make(true);
    }
