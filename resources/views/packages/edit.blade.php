...
@section('main-content')
    <div class="container-fluid" >
        ...
        <div class="box box-danger col-md-12" >
            ...
            <form role="form" id="add-package" action="/save_package/{{$package->id}}" method="post">
                {{ csrf_field() }}
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input id="number_of_members" name="number_of_members" type="text" class="form-control" placeholder="Team Size" value="{{$package->number_of_members}}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 form-group">
