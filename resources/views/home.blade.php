    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-3 col-md-6">
                <div class="card">
                    <div class="body">
                        <h3 class="m-b-0 number count-to" data-from="0" data-to="{{count(App\User::all())}}" data-speed="2000" data-fresh-interval="700">{{count(App\User::all())}} <i class="zmdi zmdi-trending-up float-right"></i></h3>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card">
                    <div class="body">
                        <h3 class="m-b-0 number count-to" data-from="0" data-to="{{count(App\Team::all())}}" data-speed="2000" data-fresh-interval="700">{{count(App\Team::all())}} <i class="zmdi zmdi-trending-up float-right"></i></h3>
                        <p class="text-muted">Teams</p>
                        <div class="progress">
                            <div class="progress-bar l-turquoise" role="progressbar" aria-valuenow="{{count(App\Team::all())}}" aria-valuemin="0" aria-valuemax="100" style="width: 68%;"></div>
                        </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card">
                    <div class="body">
                        <h3 class="m-b-0 number count-to" data-from="0" data-to="{{count(App\Package::all())}}" data-speed="2000" data-fresh-interval="700">{{count(App\Package::all())}} <i class="zmdi zmdi-trending-up float-right"></i></h3>
