        ...
        <div class="col-md-12">
            <div class="box box-danger">
                <div class="box-header with-border">
                    <h3 class="box-title">Edit Onboarding Material Details</h3>
                </div>
                <form role="form" id="add-material" enctype="multipart/form-data" action="/update_onboarding_materials/{{$material->id}}"
                      method="post"
                >
                    {{ csrf_field() }}
