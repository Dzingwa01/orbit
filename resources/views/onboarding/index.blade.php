...
@section('main-content')
    <div class="container-fluid" >
        <div class="row" style="margin-top:1em;">
            <div class="col-sm-2">
                <a href="{{url('onboarding_materials/create')}}" class="btn btn-success"><i class="fa fa-plus-square"></i> Add OnBoarding Material</a>
        ...
        $(document).ready(function ($) {
            $(function () {
                oTable = $('#teams_table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{route('onboarding_materials.get_materials')}}",
                    columns: [
                        {data: 'name', name: 'name'},
